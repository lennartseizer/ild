...
```{r}
# positive affect
data$pa_b <- EMAtools::pmean(data$id, data$pa)
data$pa_w <- EMAtools::pcenter(data$id, data$pa)

# negative affect
data$na_b <- EMAtools::pmean(data$id, data$na)
data$na_w <- EMAtools::pcenter(data$id, data$na)
