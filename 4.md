...
![](4_files/figure-gfm/unnamed-chunk-27-1.png)<!-- -->
...
![](4_files/figure-gfm/unnamed-chunk-30-1.png)<!-- -->
...
``` r
m4_lmer <- lmer(pa ~ eventpl_w + eventpl_bc + age + (1 + eventpl_w | id), 
                data = data, REML = TRUE)
...
```
    ...
    ## also installing the dependencies 'zip', 'xtable', 'openxlsx', 'RUnit', 'kutils', 'rockchalk'
...
![](4_files/figure-gfm/unnamed-chunk-32-1.png)<!-- -->
    ...
    ##                      total
    ## fixed           0.14779893
    ## slope variation 0.01437948
    ## mean variation  0.37000308
    ## sigma2          0.46781852
    ## 
    ## $R2s
    ##          total
...
(2 * 23.29885) / sqrt(13710)
```

    ## [1] 0.3979658

``` r
m3 <- lme(pa ~ day*status, 
          random = ~day|id,
          data = data, 
          na.action = na.omit)
...
```
    ...
    ##   Data: data 
    ##        AIC      BIC   logLik
    ##   42833.01 42909.02 -21406.5
    ## 
    ## Random effects:
    ##  Formula: ~day | id
    ##  Structure: General positive-definite, Log-Cholesky parametrization
    ##             StdDev    Corr  
    ## (Intercept) 0.9303340 (Intr)
    ## day         0.1495951 -0.437
    ## Residual    0.9735282       
    ## 
    ## Fixed effects:  pa ~ day * status 
    ##                         Value  Std.Error    DF  t-value p-value
    ## (Intercept)          5.155940 0.09322823 14461 55.30449  0.0000
    ## day                  0.008352 0.01632826 14461  0.51152  0.6090
    ## statusdepressed     -1.099869 0.13263286   325 -8.29258  0.0000
    ## statuspsychotic     -0.731680 0.13400033   325 -5.46028  0.0000
    ## day:statusdepressed -0.002204 0.02319467 14461 -0.09503  0.9243
    ## day:statuspsychotic -0.028122 0.02361345 14461 -1.19094  0.2337
    ##  Correlation: 
    ##                     (Intr) day    sttsdp sttsps dy:sttsd
    ## day                 -0.506                              
    ## statusdepressed     -0.703  0.355                       
    ## statuspsychotic     -0.696  0.352  0.489                
    ## day:statusdepressed  0.356 -0.704 -0.505 -0.248         
    ## day:statuspsychotic  0.350 -0.691 -0.246 -0.510  0.487  
    ## 
    ## Standardized Within-Group Residuals:
    ##        Min         Q1        Med         Q3        Max 
    ## -5.5740576 -0.4962357  0.0978467  0.5770086  3.9899441 
    ## 
    ## Number of Observations: 14792
    ## Number of Groups: 328

``` r
sd_dep_d1_p <- sd(data$pa[data$status=="psychotic" & data$day == 1], na.rm = T)
sd_dep_d1_c <- sd(data$pa[data$status=="control" & data$day == 1], na.rm = T)
sqrt((sd_dep_d1_p^2 + sd_dep_d1_c^2) / 2)
```
