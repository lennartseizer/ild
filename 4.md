...
>         whether participants are alone or with others
>         (`soc_alone`). b) Test whether the previous effect is
>         moderated by how pleasant the company of others is experienced
>         `soc_pleasant`. Pick an appropriate random effects structure
>         and check model assumptions.
