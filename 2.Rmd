...
```{r, fig.dim = c(8, 3), warning=F, message=F}
...
Seizer, L., Schiepek, G., Cornelissen, G., & Löchner, J. (2024). A primer on sampling rates of ambulatory assessments. Psychological Methods.
