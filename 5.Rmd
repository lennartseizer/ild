...
# Exercises
>
1. Create a power curve to find the sample size needed to test an interaction effect of -0.2 with 8 weekly assessments at a power of 95% in the above setup.
2. In the setup of Ex. 1, additionally calculate the sample size needed to estimate a moderation effect of participants’ sex (approx. equally distributed) on the treatment effect with -0.2 at a power of 80%.
