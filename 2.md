...
```
    ...
    ##     id day beep eventpl eventpl_b eventpl_w
    ## 1 c100   1    1       0       2.4      -2.4
    ## 2 c100   1    2      NA       2.4        NA
    ## 3 c100   1    3       2       2.4      -0.4
    ## 4 c100   1    4      -2       2.4      -4.4
    ## 5 c100   1    5       3       2.4       0.6
    ## 6 c100   1    6      NA       2.4        NA
...
print.data.frame(head(data[, c("id", "day", "beep", 
    "eventpl_w", "eventpl_w_l1")], 
     n = 25))
```
...
![](2_files/figure-gfm/unnamed-chunk-24-1.png)<!-- -->

**Plot participants based on association between PA and eventpl**
...
![](2_files/figure-gfm/unnamed-chunk-25-1.png)<!-- -->
...
Revol, J., Carlier, C., Lafit, G., Verhees, M., Sels, L., & Ceulemans,
E. (2024). Preprocessing experience-sampling-method data: A step-by-step
...
Seizer, L., Schiepek, G., Cornelissen, G., & Löchner, J. (2024). A
primer on sampling rates of ambulatory assessments. Psychological
Methods.
