...
`dm:soc_pleasant` - effect of $x$ when $m$ is the outcome (i.e., 𝑎 path), 𝑎𝑗
dm:fwkdis_cw or SyM - effect of 𝑀 when 𝑌 is the outcome (i.e., 𝑏 path), 𝑏𝑗
dm:fwkstrs_cw or SyX - effect of 𝑋 when 𝑌 is the outcome (i.e., direct effect), 𝑐′𝑗
dm:timec or Sm:timec - effect of covariate (timec) on 𝑀
dy:timec or Sy:timec - effect of covariate (timec) on 𝑌
...
dotplot_diag(m3_ar_infl$cooksd, name = "cooks.distance", cutoff = 4/328)
```
